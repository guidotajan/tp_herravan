...
<?php
    ...
    <div class="alert alert-danger"><?php echo isset($error) ? $error : 'Ha ocurrido un error al crear la factura.' ?></div>
<?php
  }
}
?>
  ...
  <div class="input-group">
    <select id="productoId" class="form-control" required>
      <?php foreach ($productos as $producto) { ?>
        <option value="<?php echo $producto['id'] ?>"><?php echo $producto['descripcion'].' - $'.$producto['precio'].' - Stk: '.$producto['stock'] ?></option>
      <?php } ?>
    </select>
...
<script src="../js/facturas_create.js" language="JavaScript" type="text/javascript"></script>
